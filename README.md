...
- 法官分析：勝率計算器、任職時間軸、跨法院對比（15,465 筆法官紀錄）
...
| **法官分析** | 勝率 × 法院 × 簽證類別交叉分析 | 律師需要了解裁判官傾向 | 訴訟策略制定的數據基礎 |
...
│
├── supabase/migrations/            # PostgreSQL schema 遷移 (5 個)
...
└── downloaded_cases/               # 本地資料 (gitignored)
    ...
    ├── cases.db                    #   SQLite (322 MB, FTS5+WAL)
